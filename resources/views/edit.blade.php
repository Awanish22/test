                                ...
                                <form action="{{ url('update_data/' . $item->id) }}" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="firstname" class="form-control"
                                            placeholder="Enter name here" value="{{ $item->firstname}}"/>
                                        <span style="color: red">@error('name'){{ $message }}@enderror</span>
                                        </div>
                                        <div class="form-group">
                                            <label for="name">Last Name <span style="color: red">*</span></label>
                                            <input type="text" name="lastname" class="form-control"
                                                placeholder="Enter name here" value="{{ $item->lastname}}" />
                                            <span style="color: red">@error('name'){{ $message }}@enderror</span>
                                            </div>
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="number" name="phone" class="form-control"
                                                        placeholder="Enter phone here" value="{{ $item->phone}}" />
                                                <span style="color: red">@error('phone'){{ $message }}@enderror</span>
                                                </div>
                                                <div class="form-group">
                                                    <label for="company">Company <span style="color: red">*</span></label>
                                                    <input type="number" name="company" class="form-control"
                                                        placeholder="Enter company here" value="{{ $item->company}}" />
